describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('vovan.iu92@gmail.com');                   // вводим логин
         cy.get('input[id="k_password"]').type('Ak431774');               // вводим пароль
         ...
         cy.get(':nth-child(5) > .shop__button').click();   // кликаем Купить у первого доступного аватара
